...
par(mfrow = c(2, 2))
plot(rawdata$DateTime, rawdata$Global_active_power, type = "l", ylab = "Global Active Power (Kilowatts)", xlab = "")
plot(rawdata$DateTime, rawdata$Voltage, type = "l", ylab = "Voltage", xlab = "DateTime")
...
plot(rawdata$DateTime, rawdata$Global_reactive_power, type = "l", ylab = "Global Reactive Power (Kilowatts)", xlab = "DateTime")
dev.off()
